...
rk_normal.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_standard_exponential.argtypes = [c_intp]
...
rk_exponential.argtypes = [c_intp,ct.c_double]
...
rk_uniform.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_standard_gamma.argtypes = [c_intp,ct.c_double]
...
rk_gamma.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_beta.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_chisquare.argtypes = [c_intp,ct.c_double]
...
rk_noncentral_chisquare.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_f.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_noncentral_f.argtypes = [c_intp,ct.c_double,ct.c_double,ct.c_double]
...
rk_binomial.argtypes = [c_intp,ct.c_long,ct.c_double]
...
rk_binomial_btpe.argtypes = [c_intp,ct.c_long,ct.c_double]
...
rk_binomial_inversion.argtypes = [c_intp,ct.c_long,ct.c_double]
...
rk_negative_binomial.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_poisson.argtypes = [c_intp,ct.c_double]
...
rk_poisson_mult.argtypes = [c_intp,ct.c_double]
...
rk_poisson_ptrs.argtypes = [c_intp,ct.c_double]
...
rk_standard_cauchy.argtypes = [c_intp]
...
rk_standard_t.argtypes = [c_intp,ct.c_double]
...
rk_vonmises.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_pareto.argtypes = [c_intp,ct.c_double]
...
rk_weibull.argtypes = [c_intp,ct.c_double]
...
rk_power.argtypes = [c_intp,ct.c_double]
...
rk_laplace.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_gumbel.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_logistic.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_lognormal.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_rayleigh.argtypes = [c_intp,ct.c_double]
...
rk_wald.argtypes = [c_intp,ct.c_double,ct.c_double]
...
rk_zipf.argtypes = [c_intp,ct.c_double]
...
rk_geometric.argtypes = [c_intp,ct.c_double]
...
rk_geometric_search.argtypes = [c_intp,ct.c_double]
...
rk_geometric_inversion.argtypes = [c_intp,ct.c_double]
...
rk_hypergeometric.argtypes = [c_intp,ct.c_long,ct.c_long,ct.c_long]
...
rk_hypergeometric_hyp.argtypes = [c_intp,ct.c_long,ct.c_long,ct.c_long]
...
rk_hypergeometric_hrua.argtypes = [c_intp,ct.c_long,ct.c_long,ct.c_long]
...
rk_triangular.argtypes = [c_intp,ct.c_double,ct.c_double,ct.c_double]
...
rk_logseries.argtypes = [c_intp,ct.c_double]
